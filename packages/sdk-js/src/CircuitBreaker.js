...
var Circuitbreaker = /** @class */ (function () {
    function Circuitbreaker(maxFailure, timeout) {
        if (maxFailure === void 0) { maxFailure = 3; }
    ...
    Circuitbreaker.prototype.execute = function (operation) {
        return __awaiter(this, void 0, void 0, function () {
            var now, timeSinceLastFailure, result, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, Promise.resolve(operation())];
                    case 2:
                        result = _a.sent();
                        this.failureCount = 0;
