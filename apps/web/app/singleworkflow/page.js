...
const SingleWorkflowPage = ({ params }) => {
    ...
    return (<div className="h-screen bg-gray-50 p-8">
      ...
      <div className="flex flex-col gap-3">
        {latestVersion?.steps?.map((step) => (<div key={step.id} className="bg-gray-100 border border-gray-500 p-3">
