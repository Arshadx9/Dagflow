...
export const getTotalRuns = async (ownerID) => {
...
export const getSuccessRate = async (ownerID) => {
...
export const getAverageDuration = async (ownerId) => {
...
export const getRunVolumeByDay = async (ownerId) => {
};
