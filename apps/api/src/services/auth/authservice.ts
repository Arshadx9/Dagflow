...
export const authregister = async (enteredname : string , enteredpass : string ) => {
...
export const authlogin = async (enteredname : string , enteredpass  : string) => {
 ...
 export const onboarding = async( ownerid : string)=>{
